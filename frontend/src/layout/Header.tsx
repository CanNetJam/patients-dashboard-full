    ...
    return (
        <div className="h-auto w-full bg-white rounded-full flex items-center px-4 py-1 justify-between">
            ...
            <div className='h-10 w-auto flex gap-2 items-center'>
                ...
                <div className='grid whitespace-nowrap pr-4 border-r border-gray-300'>
                ...
                <button
                    onClick={logOut}
                    className=' hover:bg-gray-200 p-1 sm:p-2 h-full flex items-center cursor-pointer rounded-full'
                >
                    <svg className="h-full w-full fill-current text-gray-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="M200-120q-33 0-56.5-23.5T120-200v-560q0-33 23.5-56.5T200-840h280v80H200v560h280v80H200Zm440-160-55-58 102-102H360v-80h327L585-622l55-58 200 200-200 200Z" /></svg>
                </button>
            </div>
        </div>
    )
