    ...
    return (
        <div className="h-auto min-h-screen container max-w-6xl bg-white rounded-xl overflow-hidden">
            <div className="flex justify-between items-center p-4 sticky top-0 bg-white">
                <label className="text-3xl font-medium">Patients</label>
                <div>
                ...
                {patients?.map((patient: Patient) => {
                    return (
                        <button
                            ...
                            className={`w-full cursor-pointer hover:bg-gray-50 flex gap-4 px-6 p-2 items-center ${false ? 'bg-green-100' : ''}`}
                        >
                            ...
                            <div className="flex justify-between items-center w-full">
                                <div className="grid">
                                    <span className="text-xl font-medium">{patient.name}</span>
